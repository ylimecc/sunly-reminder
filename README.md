...
**Recuerda lo importante.** Recordatorios bonitos y simples para organizar tu día con calma.

Sitio oficial de la app **Sunly Reminder**: landing, política de privacidad y gestión de cuenta.

**🌐 Sitio en vivo: [ylimecc.github.io/sunly-reminder](https://ylimecc.github.io/sunly-reminder/)**
...
| `delete-account.html` | Solicitud de eliminación de cuenta y datos |

## Tecnología

HTML + CSS puro, hospedado en GitHub Pages.
